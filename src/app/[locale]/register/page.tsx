...
<div>
  ...
  <div className="relative w-full">
    <DatePicker
      ...
      disabled={isLoading}
      className="w-[385px] pl-3 pr-10 py-2 border border-gray-400 text-white rounded-lg bg-[#1b1f7b] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-800 disabled:cursor-not-allowed"
    />
